...
public class PortableImpl implements Portable {
    ...
    public static PortableImpl generate() {
        return generate(random.nextInt(0x0000000F));
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(intValue, stringValue, doubleValue, longValue);
    }
